    ...
    <div className="p-8 max-w-6xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm mt-1" style={{ color: '#757575' }}>
          Here's what's happening on the Srov Meas platform today.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-5">
            {[
              { label: 'Total Users',      value: data.totalUsers,     icon: Users,     color: '#558b2f', bg: '#f0f7e6' },
              { label: 'Total Resources',  value: data.totalResources,  icon: FileText,  color: '#1e40af', bg: '#dbeafe' },
              { label: 'Active Profiles',  value: data.activeProfiles,  icon: UserCheck, color: '#92400e', bg: '#fef3c7' },
              { label: 'Analyses Logged',  value: data.totalAnalyses,   icon: BarChart2, color: '#6b21a8', bg: '#f3e8ff' },
          ...
          <div className="grid grid-cols-3 gap-5 mb-8">
            <div style={card} className="p-4 flex items-center gap-4">
              <div>
                <p className="text-xs font-medium" style={{ color: '#9e9e9e' }}>Active / Inactive Users</p>
            ...
            <div style={card} className="p-4 flex items-center gap-4">
              <div>
                <p className="text-xs font-medium" style={{ color: '#9e9e9e' }}>Published / Draft Resources</p>
                <p className="text-lg font-bold text-neutral-900 mt-0.5">
            ...
            <div style={card} className="p-4 flex items-center gap-4">
              <div>
                <p className="text-xs font-medium" style={{ color: '#9e9e9e' }}>Admin / Super Admin Accounts</p>
          ...
          <div className="grid grid-cols-3 gap-5">
            ...
            <div style={{ ...card, gridColumn: 'span 2' }} className="p-5">
              <div className="flex items-center justify-between mb-4">
                <h2 className="font-semibold text-neutral-900">Recent Analyses</h2>
                <Link to="/admin/analysis" className="text-xs font-medium no-underline flex items-center gap-1" style={{ color: '#558b2f' }}>
                  View all <ArrowRight size={12} />
                </Link>
              </div>
              {data.recent.length === 0 ? (
                <p className="text-sm text-center py-6" style={{ color: '#9e9e9e' }}>No analyses yet.</p>
              ) : (
            ...
            <div style={card} className="p-5">
              ...
              <div className="space-y-2">
                {[
                  { label: 'Add Resource',  to: '/admin/resources/new', icon: PlusCircle },
                  { label: 'Manage Users',  to: '/admin/users',         icon: Users },
                  { label: 'View Analyses', to: '/admin/analysis',      icon: BarChart2 },
                  { label: 'Add Profile',   to: '/admin/profiles',      icon: UserCheck },
