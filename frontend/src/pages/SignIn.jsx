...
export default function SignIn() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    // Demo login — no real auth backend yet
    ...
    <div className="min-h-[calc(100vh-64px)] flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-white via-primary-50/30 to-white">
        <div className="w-full max-w-md">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-2.5 text-neutral-400 hover:text-neutral-600 bg-transparent border-none cursor-pointer"
                >
          ...
          {/* Continue as Guest — above the "or" divider per Figma */}
